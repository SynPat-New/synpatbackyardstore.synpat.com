...
Class EpoDoc{
	...
	public function runUrl($token,$A,$B,$C,$D,$E){
		$error = '';
		$requestHeader = array(
		...
		/*http://ops.epo.org/3.1/rest-services/family/publication/epodoc/EP1000000/biblio*/
		
		$request_url = "http://ops.epo.org/3.1/rest-services/%s/%s/%s/%s/%s";
