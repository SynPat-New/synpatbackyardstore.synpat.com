...
class Layout {
    ...
    function __construct($params=array()) {
        ...
        /*$this->awsUrl = $this->_ci->config->slash_item('aws_server_cdn');*/
        $this->awsUrl = $this->_ci->config->slash_item('aws_server_url');
        $this->aws_server_cdn = $this->_ci->config->slash_item('aws_server_cdn');
        $this->cdnUrlHands = $this->_ci->config->slash_item('cdn_server_url_hands');
        $this->cdnUrlMain = $this->_ci->config->slash_item('cdn_server_url_main');
        $this->cdn_server_url_static = $this->_ci->config->slash_item('cdn_server_url_static');
        $this->pusher_app_id = $this->_ci->config->item('PUSHER_APP_ID');
		$this->app_cluster = $this->_ci->config->item('APP_CLUSTER');
