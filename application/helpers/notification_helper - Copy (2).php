...
{
	function buildTechnologyMenu($companyID=0){
		$CI = &get_instance();
		$CI->load->model('opportunity_model');
		$result ="";
		...
		if(count($allSectors)>0){
			...
			foreach($allSectors as $sec){
				...
				$sectorName = "<span class='show-span'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))'>{$sec->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$sec->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
			$result .= "<li class='dd-item nested-list-item' data-order='{$i}' data-id='{$sec->id}' data-type='technology'>
			  <div class='dd-handle nested-list-handle'>
				<i class='icon-move'></i>
			  </div>
			  <div class='nested-list-content'><input type='checkbox' {$parentChecked} name='preferences[technology][]' onchange='checkMeWithOther(jQuery(this),1)' value='{$sec->id}'/><div class='listbox'>{$sectorName}</div></div>";
				$categories =  $sec->sub_category;
				if(count($categories)>0){					
					$result .= "<ol class=\"dd-list\"  data-t=\"sub-technology\">\n";
					foreach($categories as $cat){
						...
						$catName = "<span class='show-span'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))'>{$cat->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$cat->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
						$result .= "<li class='dd-item nested-list-item' data-order='{$c}' data-id='{$cat->id}' data-type='sub-technology'>
						  <div class='dd-handle nested-list-handle'>
							<i class='icon-move'></i>
						  </div>
						  <div class='nested-list-content'><input class='parent' type='checkbox' {$childChecked} name='preferences[subtechnology][]' onclick='checkedMyChild(jQuery(this),1)' value='{$cat->id}'/><div class='listbox'>{$catName}</div></div>";
						  
						$subCategory = $cat->sub_sub_category;
						if(count($subCategory)>0){
							$result .= "<ol class=\"dd-list\" data-t=\"subsub-technology\">\n";							
							foreach($subCategory as $subCat){
								...
								$subcatName = "<span class='show-span'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))' title='{$toolTip}'>{$subCat->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$subCat->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
								$result .= "<li class='dd-item nested-list-item' data-order='{$c}' data-id='{$subCat->id}' data-type='subsub-technology'>
								  <div class='dd-handle nested-list-handle'>
									<i class='icon-move'></i>
								  </div>
								  <div class='nested-list-content'><input class='child' type='checkbox' {$subChildChecked} name='sub[technology][]' onclick='checkedMyParent(jQuery(this),1)' value='{$subCat->id}'/><div class='listbox'>{$subcatName}</div></div></li>";
								$s++; 
							}
							$result .="</ol>\n";
						}
	...
	function buildCompanyMenu($companyID=0){
		...
		if(count($allSectors)>0){
			...
			foreach($allSectors as $sec){
				...
				$sectorName = "<span class='show-span css-label black-check'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))'>{$sec->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$sec->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
			$result .= "<li class='dd-item nested-list-item' data-order='{$i}' data-id='{$sec->id}' data-type='sector'>
			  <div class='dd-handle nested-list-handle'>
				<i class='icon-move'></i>
			  </div>
			  <div class='nested-list-content'><input type='checkbox' {$checked} class='css-checkbox' name='company[sector][]' onchange='checkMeWithOther(jQuery(this))' value='{$sec->id}'/><div class='listbox'>{$sectorName}</div></div>";
				$categories =  $CI->general_model->getSectorDepartmentsName($sec->id);
				if(count($categories)>0){					
					$result .= "<ol class=\"dd-list\"  data-t=\"category\">\n";
					...
					foreach($categories as $cat){
						...
						if(count($findMyPreference)>0){
						  ...
						  $catName = "<span class='show-span'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))'>{$cat->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$cat->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
						$result .= "<li class='dd-item nested-list-item' data-order='{$c}' data-id='{$cat->id}' data-type='category'>
						  <div class='dd-handle nested-list-handle'>
							<i class='icon-move'></i>
						  </div>
						  <div class='nested-list-content'><input class='parent' type='checkbox' {$checked} name='preferences[departments][]' onclick='checkedMyChild(jQuery(this))' value='{$cat->id}'/><div class='listbox'>{$catName}</div></div>";
						  
						$subCategory = $CI->customer_model->categoryListWithMoreThanOne($cat->id);
						if(count($subCategory)>0){
							$result .= "<ol class=\"dd-list\" data-t=\"subcategory\">\n";							
							foreach($subCategory as $subCat){
								$checked = "";
								if(count($findMyPreference)>0){
									  foreach($findMyPreference as $pref){
								  ...
								  $subcatName = "<span class='show-span'><a class='edit-btn' href='javascript://' onclick='openForEdit(jQuery(this))'>{$subCat->name}</a><a class='btn-delete' style='margin-left:5px;' href='javascript://' onclick='deleteMe(jQuery(this))'><i class='fa fa-trash'></i></a></span><span class='edit-span' style='display:none'><input type='text' class='form-control' style='width:250px;display:inline;' value='{$subCat->name}' /><a href='javascript://' onclick='updateMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-check'></i></a><a href='javascript://' onclick='closeMe(jQuery(this));' style='margin-left:5px;'><i class='fa fa-close'></i></a></span>";
								$result .= "<li class='dd-item nested-list-item' data-order='{$c}' data-id='{$subCat->id}' data-type='subcategory'>
								  <div class='dd-handle nested-list-handle'>
									<i class='icon-move'></i>
								  </div>
								  <div class='nested-list-content'><input class='child' type='checkbox' {$checked} name='sub[departments][]' onclick='checkedMyParent(jQuery(this))' value='{$subCat->id}'/><div class='listbox'>{$subcatName}</div></div></li>";
								$s++;
							}
							$result .="</ol>\n";
						}
